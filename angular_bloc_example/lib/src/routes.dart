...
import 'package:angular_bloc_example/src/features/dashboard/dashboard.template.dart'
    as dashboard_page;
import 'package:angular_bloc_example/src/components/data_table/data_table.template.dart'
    as data_page;
...
class Routes {
  ...
  static final root =
      RouteDefinition.redirect(path: '', redirectTo: 'dashboard');
